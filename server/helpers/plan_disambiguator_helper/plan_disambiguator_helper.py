...
from helpers.graph_helper.graph_helper import convert_dot_str_to_networkx_graph
...
def get_plan_disambiguator_output_filtered_by_selection_infos(
    ...
    problem: str,
    plans: List[Plan],
) -> Tuple[List[Plan], List[ChoiceInfo], Graph, str]:
    """
    ...
    return selected_plans, choice_infos, g, dot_str
...
def get_plan_idx_edge_dict(
    edges_traversed: List[Any], plans: List[Plan]
) -> Dict[int, Any]:
    # TODO: TEST THIS
    len_edges_traversed = len(edges_traversed)
...
def get_edge_label_plan_hashes_dict(
    ...
    # TODO: TEST THIS
    plan_idx_edges_dict = get_plan_idx_edge_dict(edges_traversed, plans)
...
def get_choice_info_multiple_edges_without_landmark(
    node_with_multiple_out_edges: str,
    ...
    return ChoiceInfo(
        ...
        action_name_plan_hash_map=get_edge_label_plan_hashes_dict(
            edges_traversed, plans
        ),
    )


def get_first_achiever_out_edge_dict(
    edges_traversed: List[Any], plans: List[Plan], turn_choice_info: ChoiceInfo
) -> Dict[Any, List[Any]]:
    # TODO: TEST THIS
    """
